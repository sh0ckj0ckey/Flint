...
void LayoutMap::LayoutMapImpl::UpdateLayout()
{
    ...
    keyboardLayoutMap[0x104/*Fake key code to represent VK_WIN: VK_WIN_BOTH*/] = L"Win";
    ...
    keyboardLayoutMap[0x100/*Max DWORD for key code to disable keys: VK_DISABLED*/] = L"Disable";
}
...
std::vector<DWORD> LayoutMap::LayoutMapImpl::GetKeyCodeList(const bool isShortcut)
{
    ...
    if (!isKeyCodeListGenerated)
    {
        ...
        keyCodes.push_back(0x104/*Fake key code to represent VK_WIN: VK_WIN_BOTH*/);
